<?php /* Smarty version Smarty3-b8, created on 2010-03-22 20:28:16
...
if (!is_callable('smarty_function_html_select_date')) include 'libs/smarty/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'libs/smarty/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include 'libs/smarty/plugins/function.html_options.php';
?><?php echo '/*%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'libs/smarty/plugins/modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'libs/smarty/plugins/modifier.date_format.php\';
if (!is_callable(\'smarty_modifier_upper\')) include \'libs/smarty/plugins/modifier.upper.php\';
?>/*/%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/';?>
<?php  $_config = new Smarty_Internal_Config("config/test.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars("setup", $_smarty_tpl->smarty); ?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/<?php echo smarty_modifier_upper($_smarty_tpl->getVariable(\'Name\')->value);?>
/*/%%SmartyNocache:9531048014ba7c4d0d73b76-88841371%%*/';?></b>
